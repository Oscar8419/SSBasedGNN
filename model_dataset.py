...
class Signal_Dataset(Dataset):
    def __init__(self, path_data="D:\Dataset\\2018.01\GOLD_XYZ_OSC.0001_1024.hdf5", modulation="16QAM", snr_target=-20) -> None:
    ...
    def __len__(self):
        # len_modulation = len(self.modulation)
        # return len_modulation * self.frame_perModula
        return self.frame_perSNR
